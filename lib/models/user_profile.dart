...
class UserProfile {
  ...
  String get nomeDonivel {
    const nomes = [
      'Broto', 'Muda', 'Arbusto', 'Árvore', 'Floresta',
      'Estrela', 'Oceano', 'Cosmos', 'Mestre',
    ];
  ...
  UserProfile atualizarAcesso() =>
      copyWith(ultimoAcesso: DateTime.now());
  ...
  Map<String, dynamic> toJson() => {
    ...
    'conquistas': conquistas.map(
      (k, v) => MapEntry(k.valor, v.toJson()),
    ),
  ...
  factory UserProfile.fromJson(Map<String, dynamic> json) {
    final conquistasRaw =
        json['conquistas'] as Map<String, dynamic>? ?? {};
    final conquistas = <AchievementCategory, Achievement>{};
    for (final cat in AchievementCategory.values) {
